...
public class BeanFactoryTest {
    ...
    //     assertEquals(BeanDefinition.SCOPR_DEFAULT, bd.getScope());
    //     assertEquals("com.free.paris.service.v1.PetStoreService", bd.getBeanClassName());
    //     PetStoreService petStoreService = factory.getBean(Constant.petStoreBeanId);
    //     assertNotNull(petStoreService);
    //     PetStoreService petStoreService1 = factory.getBean(Constant.petStoreBeanId);
